...
public class marathon{
    ...
    public void printTopThree() {
        System.out.println("En kısa sürede bitiren ilk 3 öğrenci:");
    ...
    public void printLowestTimeStudent() {
        ...
        System.out.println("En kısa zamanda bitiren öğrenci: " + students[lowestTimeIndex] + ", zamanı: " + times[lowestTimeIndex]);
    }

    public void printSecondBestTime() {
        int secondBestIndex = findSecondBestIndex();
        System.out.println("En kısa zamanda bitiren ikinci öğrencinin zamanı: " + times[secondBestIndex]);
    }
